...
<body>
    <form id="form1" runat="server">
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="playerID" DataSourceID="SqlDataSource1" Height="50px" Width="601px" DefaultMode="Insert">
            <Fields>
